      ...
      <div className="mx-auto flex min-h-95  max-w-5/6 flex-col items-center justify-between gap-10  py-12 lg:flex-row ">
        ...
        <div className="max-w-2xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <button className="group flex items-center gap-2 rounded-md bg-linear-to-r from-orange-500 via-pink-500 to-purple-600 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:scale-[1.02] hover:shadow-md">
        ...
        <div className="flex shrink-0 items-center justify-center">
          <img
            ...
            className="w-65 object-contain sm:w-75 lg:w-85"
          />
        </div>
      </div>
    </section>
